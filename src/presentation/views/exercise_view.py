...
class ExerciseView(ctk.CTkFrame):
    def __init__(self, master, exercises_list, on_exit, check_use_case, progress_use_case, ai_use_case):
        ...
        self.grid_columnconfigure(0, weight=3) # Coluna do Problema
        self.grid_columnconfigure(1, weight=2) # Coluna do Chat
    ...
    def load_exercise(self):
        ...
        ).pack(anchor="nw", padx=0, pady=0)

        ctk.CTkLabel(
            self.problem_frame, 
            text=f"Exercício {self.current_idx + 1}", 
    ...
    def verify_answer(self):
        ...
        if is_correct:
            ...
            self.add_chat_message("Hmm, deixe-me analisar seu erro...", is_user=False)
    ...
    def add_chat_message(self, text, is_user=False):
        align = "e" if is_user else "w" # Direita (Usuário) ou Esquerda (IA)
